...
from xtts2.msg import english_stream_ttsAction, english_stream_ttsFeedback, english_stream_ttsResult
...
class TTSActionServer:
    def __init__(self):
        ...
        voice_path = os.path.join(voice_clone_path, "female01.wav")
